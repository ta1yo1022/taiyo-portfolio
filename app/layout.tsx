...
export const metadata:Metadata={metadataBase:new URL('https://taiyo-mizuno-portfolio.ta1yo1022.chatgpt.site'),title:'水野太陽',description:'水野太陽のポートフォリオ',openGraph:{title:'水野太陽',description:'水野太陽のポートフォリオ',type:'website'},twitter:{card:'summary',title:'水野太陽',description:'水野太陽のポートフォリオ'}};
