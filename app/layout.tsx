...
export const metadata:Metadata={metadataBase:new URL('https://taiyo-mizuno-portfolio.ta1yo1022.chatgpt.site'),title:'水野太陽',description:'水野太陽のポートフォリオ',icons:{icon:'/favicon.png',shortcut:'/favicon.png',apple:'/favicon.png'},openGraph:{title:'水野太陽',description:'水野太陽のポートフォリオ',type:'website'},twitter:{card:'summary',title:'水野太陽',description:'水野太陽のポートフォリオ'}};
